 ...
 * Después de comprobar el posible error, se ejecuta en un bucle infinito
...
void *funcionThread (void *parametro)
{
	...
	while (1)
	{
		...
		printf("buffer0: %d, buffer %d: %d",buffer[0],i, buffer[i]);
